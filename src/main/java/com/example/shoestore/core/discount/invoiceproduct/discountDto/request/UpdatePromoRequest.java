...
@AllArgsConstructor
@ToString
public class UpdatePromoRequest extends BaseDTO {
    ...
    @NotNull(message = MessageCode.Discount.MIN_PRICE_NOT_NULL)
    ...
    @NotNull(message = MessageCode.Discount.START_DATE_NOT_NULL)
    private String startDate;

    @NotNull(message = MessageCode.Discount.END_DATE_NOT_NULL)
